...
export const opponentW2S1 = {
  x: conversions.x * -OPPONENT_WIDTH,
  y: conversions.y * 450,
};
const butterflyEndW2S1 = [
  // Left twobutterflies
  {
    x: conversions.x * (215 - 1 * (10 + OPPONENT_WIDTH)),
    y: conversions.y * (2 * OPPONENT_HEIGHT),
  },
  {
    x: conversions.x * (215 - 1 * (10 + OPPONENT_WIDTH)),
    y: conversions.y * (3 * OPPONENT_HEIGHT),
  },
  // Right two butterflies
  {
    x: conversions.x * (215 + 2 * (10 + OPPONENT_WIDTH)),
    y: conversions.y * (2 * OPPONENT_HEIGHT),
  },
  {
    x: conversions.x * (215 + 2 * (10 + OPPONENT_WIDTH)),
...
export const opponentStartW2S1 = {
  x: conversions.x * -OPPONENT_WIDTH,
  y: conversions.y * 450,
};
const bossGalagaEndW2S1 = [
  {
    x: conversions.x * (215 - 1 * (10 + OPPONENT_WIDTH)),
    y: conversions.y * (1 * OPPONENT_HEIGHT),
  },
  {
    x: conversions.x * (215 + 0 * (10 + OPPONENT_WIDTH)),
    y: conversions.y * (1 * OPPONENT_HEIGHT),
  },
  {
    x: conversions.x * (215 + 1 * (10 + OPPONENT_WIDTH)),
...
export const waveTwoInformation = {
  waveNumber: 2,
  trailInfo: [
    {
      start: opponentStartW2S1,
      end: butterflyEndW2S1,
      paths: [...opponentPathsW2S1()],
    },
  ],
};
