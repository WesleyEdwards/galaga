...
function leftAttackPattern(path: Coordinates[]) {
    ...
    path.push({ x: convX * 405, y: convY * 360 });
    path.push({ x: convX * 445, y: convY * 390 });
    path.push({ x: convX * 480, y: convY * 450 });
    path.push({ x: convX * 300, y: convY * 490 });
    path.push({ x: convX * 255, y: convY * 510 });
    path.push({ x: convX * 210, y: convY * 530 });
...
function rightAttackPattern(path: Coordinates[]){
    ...
    path.push({ x: convX * 95, y: convY * 360 });
    path.push({ x: convX * 55, y: convY * 390 });
    path.push({ x: convX * 20, y: convY * 450 });
    path.push({ x: convX * 200, y: convY * 490 });
    path.push({ x: convX * 245, y: convY * 520 });
    path.push({ x: convX * 290, y: convY * 560 });
